"""
Plot the returns of Tabular, MLP, and EMLP
...
avg_linear = np.mean(returns_linear, axis=0)
std_linear = 1.96 * np.std(returns_linear, axis=0) / np.sqrt(returns_linear.shape[0])
...
avg_emlp = np.mean(returns_emlp, axis=0)
std_emlp = 1.96 * np.std(returns_emlp, axis=0) / np.sqrt(returns_emlp.shape[0])
...
avg_mlp = np.mean(returns_mlp, axis=0)
std_mlp = 1.96 * np.std(returns_mlp, axis=0) / np.sqrt(returns_mlp.shape[0])
